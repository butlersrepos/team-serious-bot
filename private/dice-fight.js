...
function createNewFight() {
	...
	var fight = function fight() {
		...
		if( lastRoll != 1 ) {
			setTimeout( function() { fight(); }, fightStaggerTime );
		}
	};
	
	var addFighter = function addFighter(name) {
	...
	var sendOpenChallenge = function sendOpenChallenge(name) {
	...
	return {
		...
		getFirstFighter: function() { console.log("getFirstFighter");return fighter1; }
	};
};